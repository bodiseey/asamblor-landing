...
export default function AgentStudioCard() {
    return (
        <div
            className="card-top max-w-[32rem] mx-auto overflow-hidden relative transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] bg-neutral-900/50 rounded-[1.2em] border border-white/10"
        ...
        >
            ...
            <div className="flex flex-col h-full p-6 pb-7">
                <div className="flex justify-between items-start mb-2">
                    <div className="w-3/4">
                        <h1 className="text-[26px] leading-tight tracking-tight font-medium text-white">Agent Studio</h1>
                        <p className="text-neutral-300 text-sm font-light mt-1">Orchestrator • AI-Powered</p>
                    </div>
                    <div className="w-1/4 text-right">
                        <div className="text-[20px] font-semibold font-mono text-white">AI-AGENTS</div>
                    ...
                    <div className="relative rounded-lg bg-[#0B0F14] ring-1 ring-white/10 overflow-hidden">
                        <div className="flex items-center justify-between px-3 py-2 border-b border-white/5 bg-neutral-950/50">
                            ...
                            <div className="flex items-center gap-2 rounded-full border border-white/10 bg-neutral-900/60 px-2 py-1 text-xs text-neutral-300">
                                <span className="text-neutral-400/80">agents…</span>
                            </div>
                        </div>
                        <div className="relative h-32 font-mono text-[11px]">
                            <div className="absolute inset-0 grid grid-cols-[30px_1fr]">
                                <div className="select-none border-r border-white/5 bg-neutral-950/30 px-2 py-2 text-neutral-400/50 flex flex-col gap-1">
                                    <div>1</div><div>2</div><div>3</div><div>4</div><div>5</div><div>6</div><div>7</div><div>8</div>
                                </div>
                                <div className="m-0 overflow-hidden px-3 py-2 text-neutral-300 flex flex-col gap-[2px]">
                                    <div><span className="text-blue-300">class</span> <span className="text-white">OrchestratorAgent</span>:</div>
                ...
                <div className="mt-auto flex justify-between w-full">
                    <span className="opacity-70 flex items-center gap-2 text-sm mb-1 text-white">
