        ...
        <main className="relative min-h-screen bg-black text-white selection:bg-purple-500/30">
            ...
            <div className="relative pt-32 pb-24 max-w-[900px] mx-auto px-8">
                ...
                >
                    ...
                    <Link href="/" className="inline-flex items-center gap-2 text-purple-400 hover:text-purple-300 transition-colors mb-8 group">
                    ...
                    <div className="space-y-12 text-gray-300 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                <span className="text-purple-500">02.</span> User Compliance & TCPA
                            </h2>
                            <p className="mb-4">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                <span className="text-purple-500">03.</span> Fees & Professional Services
                            </h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                <span className="text-purple-500">04.</span> Intellectual Property
                            </h2>
                            <p>
